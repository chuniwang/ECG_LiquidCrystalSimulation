...
device = 'cpu'
torch.set_default_tensor_type(torch.FloatTensor)
NN_archi = 'H4'  #Number of hidden layers of neural network: please type "H4" or "H7"
...
class Net_H7(nn.Module):
  def __init__(self,input_shape):
    super(Net_H7,self).__init__()
    ...
    self.fc7 = nn.Linear(50,32)
    self.fc8 = nn.Linear(32,1)
    self.batchnorm_0 = torch.nn.BatchNorm1d(input_shape)
    self.batchnorm_1 = torch.nn.BatchNorm1d(500)
    self.batchnorm_2 = torch.nn.BatchNorm1d(400)
    self.batchnorm_3 = torch.nn.BatchNorm1d(300)
    self.batchnorm_4 = torch.nn.BatchNorm1d(200)
    self.batchnorm_5 = torch.nn.BatchNorm1d(100)
    self.batchnorm_6 = torch.nn.BatchNorm1d(50)
  ...
  def forward(self,x):
    ...
    x = torch.relu(self.fc5(self.batchnorm_4(x)))
    x = torch.relu(self.fc6(self.batchnorm_5(x)))
    x = torch.relu(self.fc7(self.batchnorm_6(x)))
    x = torch.sigmoid(self.fc8(x))
    return x

############ defining the network ############
class Net_H4(nn.Module):
  def __init__(self,input_shape):
    super(Net_H4,self).__init__()
...
def main():    
    ...
    Feature_type = "CG_"
    Model_type = NN_archi +'_BS500_LR'
    
    #### Training dataset #####
    Xfilename = '/home/ciwang/Electronic_Coupling/ML_Dataset/700K/Feature_Coupling_CG_Improve_25_Inter_Training.npy'
    Yfilename = '/home/ciwang/Electronic_Coupling/ML_Dataset/700K/Label_Coupling_Sample_128000.npy'

    ##### Testing dataset #####
    Xfilename_test = '/home/ciwang/Electronic_Coupling/ML_Dataset/700K/Feature_Coupling_CG_Improve_25_Inter_Testing.npy'
